...
export default function StudioPage() {
  ...
  async function generate() {
    ...
    try {
      ...
      setMessage(data.demo ? "Demo mode: добави OPENAI_API_KEY за истински AI." : "Готово.");
    } catch (e) {
    ...
    <>
      ...
      <main className="studio">
        <section className="panel">
          ...
          <p>Постави тема, лекция или конспект. Free лимитът се пази server-side cookie.</p>
